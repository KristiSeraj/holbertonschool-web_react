...
describe('Testing <App /> component', () => {
    ...
    describe('Test mapStateToProps function', () => {
        it('should verify that the function returns the right object with isLoggedIn', () => {
            let state = fromJS({
                isUserLoggedIn: true
              });
        ...
        it('should verify that the function returns the right object with displayDrawer', () => {
            let state = fromJS({
                displayDrawer: true
            });
            const result = mapStateToProps(state);
